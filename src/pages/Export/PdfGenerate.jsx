...
function PdfGenerate() {
  ...
  const steps = [doI18n("pages:core-contenthandler_text_translation:pick_book", i18nRef.current), doI18n("pages:core-contenthandler_text_translation:pick_book_format", i18nRef.current)];
  ...
  const handleExportPdf = () => {
    if (!fileExport.current || !selectedBooks || selectedBooks.length === 0) {
        console.log(fileExport.current);
      ...
      switch (step) {
          case 0:
              return (
                  <>
                      <FormGroup>
                          <List dense sx={{ height: "100%", width:"100%" }}>
                            {bookCodes
                                ...
                                .map((bookName) => (
                                    <ListItem
                                        key={bookName}
                                        button
                                        onClick={() => { handleToggle(bookName); setBookIsSelected(true); fileExport.current = bookName }}
                                        sx={{
                                    ...
                                    >
                                        <ListItemText
                                            primary={ `${bookName} - ` +doI18n(`scripture:books:${bookName}`, i18nRef.current) }
                                        />
                                    </ListItem>
                                ))}
                          </List>
          ...
          case 1:
              return (
                  <>
                      <FormGroup>
                          <List sx={{ height:"100%", width: '95%', bgcolor: 'background.paper'}}>
