...
function ZipExport() {
  ...
  const usfmExportZipContents = async (bookCode) => {
    ...
    const usfmFile = {
      filename: `${bookCode}.usfm`,
      usfmText: `${bookUsfmResponse.text}`,
    };
        ...
        >
          <Toolbar>
            <Typography variant="h6" component="div">
              {doI18n(
                "pages:core-contenthandler_text_translation:export_as_zip",
                i18nRef.current,
              )}
            </Typography>
          </Toolbar>
              ...
              renderValue={(selected) => {
                ...
                return (
                  <Box sx={{ whiteSpace: "normal", wordWrap: "break-word" }}>
                    {selected
                      .map((s) =>
                        doI18n(`scripture:books:${s}`, i18nRef.current),
                      )
                      .join(", ")}
                  </Box>
                );
            ...
            <FormControl>
              ...
              >
                ...
                <FormControlLabel
                  ...
                  control={<Radio />}
                  label={doI18n(
                    "pages:core-contenthandler_text_translation:export_all",
                    i18nRef.current,
                  )}
                />
              </RadioGroup>
