...
export default function Bcv({props}) {
  return (
    <SvgIcon {...props}>
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_1567_23062)" id="BcvBible">
          ...
          <g clip-path="url(#clip1_1567_23062)">
            ...
            <path d="M38.6773 53.44V54H36.6023V53.44H37.3023V51.6025C37.3023 51.5558 37.3031 51.5092 37.3048 51.4625C37.3065 51.4142 37.309 51.3658 37.3123 51.3175L36.8973 51.6625C36.8606 51.6908 36.824 51.7083 36.7873 51.715C36.7523 51.72 36.719 51.72 36.6873 51.715C36.6556 51.7083 36.6273 51.6975 36.6023 51.6825C36.5773 51.6658 36.559 51.6492 36.5473 51.6325L36.3023 51.3075L37.4373 50.355H38.0773V53.44H38.6773Z" fill="black" />
          </g>
        </g>
        <defs>
